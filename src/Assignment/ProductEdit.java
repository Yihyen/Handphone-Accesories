    ...
    public static void editIphone(){
    	...
    	switch(choose1){
    		case 1: {
    			...
    			iphone[choose-1].setphoneName(name);                //setter
    			break;
    		...
    		case 2:{
    			...
    			iphone[choose-1].setphoneColour(colour);            //setter
    			break;
    		}
    		...
    		case 3:{
    			...
    			iphone[choose-1].setphonePrice(price);                     //setter
    			break;
    		}
    		case 4:{
    			int qty;
    			...
    			iphone[choose-1].setphoneQty(qty);                     //setter
    			break;
    	}
    ...
    public static void editSamsung(){
    	...
    	switch(choose1){
    		case 1: {
    			System.out.println("Name :");
    			String name = input.nextLine();
    			samsung[choose-1].setphoneName(name);                //setter
    			break;
    		...
    		case 2:{
    			System.out.println("Colour :");
    			String colour = input.nextLine();
    			samsung[choose-1].setphoneColour(colour);            //setter
    			break;
    		}
    		...
    		case 3:{
    			...
    			samsung[choose-1].setphonePrice(price);                     //setter
    			break;
    		}
    		case 4:{
    			int qty;
    			...
    			samsung[choose-1].setphoneQty(qty);                     //setter
    			break;
    	}
    ...
    public static void editHuawei(){
    	...
    	switch(choose1){
    		case 1: {
    			System.out.println("Name :");
    			String name = input.nextLine();
    			huawei[choose-1].setphoneName(name);                //setter
    			break;
    		...
    		case 2:{
    			System.out.println("Colour :");
    			String colour = input.nextLine();
    			huawei[choose-1].setphoneColour(colour);            //setter
    			break;
    		}
    		...
    		case 3:{
    			...
    			huawei[choose-1].setphonePrice(price);                     //setter
    			break;
    		}
    		case 4:{
    			int qty;
    			...
    			huawei[choose-1].setphoneQty(qty);                     //setter
    			break;
    	} 
    ...
    public static void editAccessories(){
    	...
    	switch(choose1){
    		case 1: {
    			System.out.println("Name :");
    			String name = input.nextLine();
    			accessories[choose-1].setaccessoriesName(name);                //setter
    			break;
    		...
    		case 2:{
    			System.out.println("Colour :");
    			String colour = input.nextLine();
    			accessories[choose-1].setaccessoriesColour(colour);            //setter
    			break;
    		}
    		...
    		case 3:{
    			...
    			accessories[choose-1].setaccessoriesPrice(price);                     //setter
    			break;
    		}
    		case 4:{
    			int qty;
    			...
    			accessories[choose-1].setaccessoriesQty(qty);                     //setter
    			break;
    		}
    	}
