...
public class Report extends OrderProduct{
    ...
    public static void report(){
    	...
    	switch(choice){
    		...
    		{
    			System.out.println("\n=============================================================");
    			System.out.println("\t******Member Total Buy Report*****");
    			System.out.println("=============================================================");
                        System.out.println("\tMemberID\tName\tTotal Buy(RM)");
    		...
    		case 3:
    		{
    			...
    			System.out.println("=============================================================");
    			System.out.println("StaffID  Name\t\tTotal Sales(RM)");
    			System.out.println("=============================================================");
    			...
    			for(int i=0;i<StaffData.ExistingStaff;i++)
    			{
    				if(StaffData.MobileStaffs[i].getSales()!=0){
    					...
    					String.format("%-17.2f",StaffData.MobileStaffs[i].getSales()));
    					System.out.println("-------------------------------------------------------------");
    				}
    		...
    		case 5:
    		{
    			...
    			{
    				stockI+=iphone[i].getphoneQty();
    			}
    			for(int i=0;i<ProductFunction.counterS;i++)
    			{
    				stockS+=samsung[i].getphoneQty();
    			}
    			for(int i=0;i<ProductFunction.counterH;i++)
    			{
    				stockH+=huawei[i].getphoneQty();
    			}
    			for(int i=0;i<ProductFunction.counterA;i++)
    			{
    				stockA+=accessories[i].getaccessoriesQty();
    			}
    			...
    			System.out.println("=================================================================");
                        for (int i = 0; i < counterOrder; i++){
                            ...
                            System.out.println("" + cust[i].getOrderID()+ "\t"+cust[i].getStatus());
