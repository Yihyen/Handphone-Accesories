...
public class ProductSearch extends ProductFunction{
    ...
    public static void searchIphone()
    {
    	...
    	if(choose==1){
    		...
    		{
    			if((iphone[i].getproductName()).equals(name))       //search
    			{	
    				a=i;
    				match=true;
    				break;
    	...
    	else if(choose==2)
    	{
    		...
    		for(int i=0;i<counterI;i++)                              //counter
    		{
    			if((iphone[i].getproductID()).equals(name))              //search
    			{	
    				a=i;
    				match=true;
    				break;
    ...
    public static void searchSamsung()
    {
    	...
    	if(choose==1){
    		...
    		{
    			if((samsung[i].getproductName()).equals(name))       //search
    			{	
    				a=i;
    				match=true;
    				break;
    	...
    	else if(choose==2)
    	{
    		...
    		for(int i=0;i<counterS;i++)                              //counter
    		{
    			if((samsung[i].getproductID()).equals(name))              //search
    			{	
    				a=i;
    				match=true;
    				break;
    ...
    public static void searchHuawei()
    {
    	...
    	if(choose==1){
    		...
    		{
    			if((huawei[i].getproductName()).equals(name))       //search
    			{	
    				a=i;
    				match=true;
    				break;
    	...
    	else if(choose==2)
    	{
    		...
    		for(int i=0;i<counterH;i++)                              //counter
    		{
    			if((huawei[i].getproductID()).equals(name))              //search
    			{	
    				a=i;
    				match=true;
    				break;
    ...
    public static void searchAccessories()
    {
    	...
    	if(choose==1){
    		...
    		{
    			if((accessories[i].getproductName()).equals(name))       //search
    			{	
    				a=i;
    				match=true;
    				break;
    	...
    	else if(choose==2)
    	{
    		...
    		for(int i=0;i<counterA;i++)                              //counter
    		{
    			if((accessories[i].getproductID()).equals(name))              //search
    			{	
    				a=i;
    				match=true;
    				break;
